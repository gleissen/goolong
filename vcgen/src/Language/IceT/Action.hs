...
module Language.IceT.Action where
...
-- import           Language.IceT.Types hiding (CFG, actions, Action(..))
...
--                        , actionTypeEnv :: HM.HashMap Id Sort -- extra type information needed
--                        , actionPath    :: [ Prop a ]         -- path condition (i.e. if stmt conditions)
--                        }
...
--     go m s =
--       case s of
--         Atomic  {..} -> IM.insert atomicLabel undefined m
