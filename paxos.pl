prog(tmp, 
     ...
     seq([for(_,A,ps,r,
              true,
              atomic(seq([pre(A,and([ref(t,A)>0,
                                     ref(ready,A)=0,
                                     ref(decided,A)=0,
                                     ref(ho,A)=0,
                                     ref(k,A)=0,
          ...
          sym(A,ps,
              seq([for(A,C,as,_,
                       true,
                       seq([atomic(seq([pre(A,forall([decl(i,int)],
                   ...
                   ite(A,2*ref(ho,A)>card(as),
                       seq([pre(A,forall([decl(i,int)],
                                         implies(and([elem(i,ps),ref(decided,i)=1]),and([ref(k,i)>card(as)/2,ref(ho,i)>card(as)/2,ref(ready,i)=1])))),
                            pre(A,forall([decl(i,int)],implies(and([elem(i,ps),here(i)]),and([ref(decided,i)=0,ref(k,i)=0,ref(k,i)+ref(l,i)+ref(m,i)=card(as)])))),
                            assign(A,ho,0),
                            assign(A,ready,1),
                            for(A,C,as,_,
                                true,
                                seq([atomic(seq([pre(A,forall([decl(qa,int),decl(qp,int)],
